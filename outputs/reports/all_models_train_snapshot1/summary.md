...
Total current models in this report: `13`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| custom_title_abstract_rerank_temporal | temporal | 0.3518 | 0.4804 | 0.2977 | 0.7141 | 0.7619 |
...
| official_pyterrier_dense_temporal | temporal | 0.2993 | 0.4581 | 0.2498 | 0.6406 | 0.8613 |
...
| custom_title_abstract_rm3_temporal | temporal | 0.0154 | 0.1841 | 0.0144 | 0.0433 | 0.8701 |
| custom_lexical_fulltext_temporal | temporal | 0.0088 | 0.1935 | 0.0091 | 0.0213 | 0.9245 |
| official_pyterrier_temporal | temporal | 0.0053 | 0.1749 | 0.0083 | 0.0298 | 0.8581 |

## Raw Results

| Method | Family | nDCG@10 | nDCG@1000 | MAP | Recall@100 | Recall@1000 |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| custom_title_abstract_rerank_temporal | temporal | 0.3720 | 0.5139 | 0.2988 | 0.7068 | 0.7596 |
...
| official_pyterrier_dense_temporal | temporal | 0.3321 | 0.4992 | 0.2545 | 0.6342 | 0.8555 |
...
| custom_title_abstract_rm3_temporal | temporal | 0.0129 | 0.2008 | 0.0106 | 0.0377 | 0.8688 |
| custom_lexical_fulltext_temporal | temporal | 0.0095 | 0.2129 | 0.0094 | 0.0217 | 0.9205 |
| official_pyterrier_temporal | temporal | 0.0055 | 0.1947 | 0.0088 | 0.0304 | 0.8561 |
